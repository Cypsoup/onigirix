...
<body class="bg-white min-h-screen pb-20 font-sans">
    ...
    <div id="drawer" class="fixed inset-0 z-50 hidden">
        ...
        <div id="drawerContent" class="absolute bottom-0 left-0 right-0 bg-white border-t-2 border-black max-h-[85vh] overflow-y-auto translate-y-full transition-transform duration-300 ease-out">
            ...
            <div class="px-6 pb-8 pt-2">
                ...
                <h2 class="text-3xl font-black italic uppercase text-black text-center mb-2" id="drawerName">Sake Onigiri</h2>
                
                <p class="text-xl font-mono font-black text-center mb-6" style="color: #E60012;" id="drawerPrice">3.50€</p>
                ...
                <div class="flex items-center justify-center gap-6 mb-8">
                    <button onclick="changeQty(currentItem.id, -1)" class="w-12 h-12 border-2 border-black bg-white flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 transition-transform">
                    ...
                    <button onclick="changeQty(currentItem.id, 1)" class="w-12 h-12 border-2 border-black bg-[#E60012] flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 transition-transform">
                ...
                <button onclick="closeDrawer()" class="w-full bg-black text-white font-bold uppercase tracking-widest text-sm py-4 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 transition-transform">
    ...
    <div id="cartFooter" class="cart-footer fixed bottom-0 left-0 right-0 bg-white border-t-2 border-black px-6 py-4 z-30">
        <div class="flex items-center justify-between">
            ...
            <button onclick="openValidation()" class="bg-[#E60012] text-white font-bold px-8 py-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 transition-transform">
                SUIVANT
            </button>
        </div>
    </div>

    <div id="validationOverlay" class="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm hidden flex items-center justify-center px-5 transition-opacity duration-300 ease">
        <div id="validationContent" class="bg-white border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-8 w-full max-w-md scale-90 opacity-0 transition-all duration-300 ease-out relative">
            ...
            <button onclick="closeValidation()" class="absolute -top-4 -right-4 w-10 h-10 bg-white border-2 border-black flex items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 transition-transform">
                <svg class="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center mb-8">
                <div class="w-16 h-16 mx-auto border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-zinc-50 flex items-center justify-center mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#E60012" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
            ...
            <button onclick="submitOrder()" class="w-full bg-[#E60012] text-white font-black italic uppercase tracking-widest py-4 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 transition-transform text-lg">
                VALIDER 
            </button>
        </div>
    </div>
